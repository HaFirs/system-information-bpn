...
<div class="container mt-5">
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-8">
            <form id="regForm">
                <h1 id="register">Penilaian  Anda Terhadap Layanan Kami</h1>
                <div class="all-steps" id="all-steps"> <span class="step"><i class="fa">1 </i></span> <span class="step"><i class="fa"></i>2 </span> <span class="step"><i class="fa ">3 </i></span> <span class="step"><i class="fa ">4 </i></span> <span class="step"><i class="fa">5 </i></span> <span class="step"><i class="fa">6 </i></span> <span class="step"><i class="fa">7 </i></span> <span class="step"><i class="fa">8 </i></span> <span class="step"><i class="fa">9 </i></span> <span class="step"><i class="fa">10 </i></span><span class="step"><i class="fa">11 </i></span> </div>
                <div class="tab">
                    <h6>Masukan Nama Anda</h6>
                    <p> <input placeholder="Name..." oninput="this.className = ''" name="fname"></p>
                </div>
                <div class="tab">
                    <h6>Masukan Nomor HP</h6>
                    <p><input placeholder="City" oninput="this.className = ''" name="dd"></p>
                </div>
                <div class="tab">
                    <h6>Kesesuaian Persyaratan</h6>
                    <p><input placeholder="Favourite Shopping site" oninput="this.className = ''" name="email"></p>
                </div>
                <div class="tab">
                <h6>Kemudahan Prosedur Pelayanan</h6>
                ...
                <div class="tab">
                    <h6>Kelengkapan Sarana dan Prasarana</h6>
                    <p><input placeholder="Favourite Mobile Brand" oninput="this.className = ''" name="uname"></p>
                </div>
