  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/si1.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
          	<span class="subheading">Selamat Datang</span>
            <h1 class="mb-4">ATR / BPN Kantah Kota Palangka Raya</h1>
            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">Layanan Kami</a></p>
          </div>
        </div>
        </div>
      </div>
    ...
    <section class="ftco-section page-scroll" id="saran">
			<div class="container">
